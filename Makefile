...
GCC_BIN = 
PROJECT = BikeOdometer
OBJECTS = ./main.o ./SDFileSystem/SDFileSystem.o ./SDFileSystem/FATFileSystem/FATDirHandle.o ./SDFileSystem/FATFileSystem/FATFileHandle.o ./SDFileSystem/FATFileSystem/FATFileSystem.o ./SDFileSystem/FATFileSystem/ChaN/ccsbcs.o ./SDFileSystem/FATFileSystem/ChaN/diskio.o ./SDFileSystem/FATFileSystem/ChaN/ff.o ./AutoSDLogger/AutoSDLogger.o ./LPS25H/LPS.o ./LSM303/LSM303.o ./L3G/L3G.o ./FXOS8700Q/FXOS8700Q.o ./BLEMate2/MTSBufferedIO.o ./BLEMate2/SparkFunConnections.o ./BLEMate2/SparkFunBLEMate2.o ./BLEMate2/MTSSerialFlowControl.o ./BLEMate2/itoas.o ./BLEMate2/WString.o ./BLEMate2/MTSSerial.o ./SocketModem/cellular/Cellular.o ./SocketModem/Socket/Endpoint.o ./SocketModem/Socket/TCPSocketConnection.o ./SocketModem/Socket/Transport.o ./SocketModem/Socket/Socket.o ./SocketModem/tests/test_main.o ./SocketModem/utils/MTSCircularBuffer.o ./SocketModem/utils/MTSText.o ./SocketModem/wifi/Wifi.o 
...
CC_SYMBOLS = -DTARGET_KPSDK_MCUS -DTARGET_FF_ARDUINO -DTOOLCHAIN_GCC_ARM -DTOOLCHAIN_GCC -DCPU_MK64FN1M0VMD12 -DTARGET_FRDM -DTARGET_CORTEX_M -D__FPU_PRESENT=1 -DTARGET_KPSDK_CODE -DTARGET_M4 -DMBED_BUILD_TIMESTAMP=1449629705.6 -D__MBED__=1 -DTARGET_K64F -DTARGET_Freescale -D__CORTEX_M4 -DFSL_RTOS_MBED -DTARGET_MCU_K64F -DARM_MATH_CM4 
